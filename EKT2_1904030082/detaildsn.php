  ...
  <div class="row mt-5">
    <div class="col-md-2 mt-2 pr-3 pt-4 bg-secondary">
      ...
      <ul class="nav flex-column">
        <li class="nav-item">
          <a class="nav-link text-white" aria-current="page" href="view.php"><i class="fas fa-tachometer-alt"></i>
            Dashboard</a>
          <hr class="bg-dark">
        </li>
        <li class="nav-item">
    ...
    <div class="col-md-10 p-5 pt-5">
      ...
      <hr>
      <ul class="list-group">
        <li class="list-group-item"><img src="images/foto1.png" <?= $dosenn['foto']; ?> width="400px"></li>
        ...
        <li class="list-group-item">
          <a href="hapus.php?nidn=<?= $dosenn['nidn']; ?>"
            onclick="return confirm('Apakah Anda Akan Menghapus Data Ini');" class="btn btn-danger"
            role="button">Hapus</a>
